            ...
            <div class="card-body text-center p-5">
                ...
                <div class="row text-start g-3">
                    ...
                    <div class="col-6">
                        ...
                        <div class="fw-medium">{{ auth()->user()->devices()->count() }} units</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-8">
        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-header bg-white py-3">
                <h6 class="mb-0 fw-bold"><i class="bi bi-person-gear me-2"></i>Account Information</h6>
            </div>
                ...
                <form method="post" action="{{ route('profile.update') }}" class="mt-2" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        <div class="col-md-12 text-center mb-4">
                            ...
                            <div class="small text-muted mt-2">Click the camera icon to change your profile picture</div>
        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-header bg-white py-3">
                <h6 class="mb-0 fw-bold"><i class="bi bi-shield-lock me-2"></i>Security & Password</h6>
            </div>
            <div class="card-body p-4">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12 mt-4">
                            ...
                            @if (session('status') === 'password-updated')
                                <span class="text-success small ms-2"><i class="bi bi-check-circle me-1"></i>Password updated!</span>
                            @endif
                        </div>
                    </div>
                </form>
